...
* [**Блок 3: Ветвление и совместная работа**](#блок-3-ветвление-и-совместная-работа)
  ...
  * [15. Синхронизация в ветках Git](#15-синхронизация-в-ветках-git)
  * [16. Синхронизация (Sync) Форка](#16-синхронизация-sync-форка)
  * [17. Работа в команде](#17-работа-в-команде)
...
### 18. Отмена несохранённых изменений
...
### 19. Отмена сохранённых изменений
...
### 22. Храни временные изменения с заметкой
...
### 25. Повторное разрешение конфликтов
...
### 26. Автоматический поиск «битого» коммита
...
### 27. Несколько рабочих копий одного репозитория
