...
3. Нельзя удалить ветку если вы вней находитесь .
4. Нельзя удалить не слитую ветку но вы можете сделать это принудительно с помощью команды - `git branch -D + имя ветки` .
