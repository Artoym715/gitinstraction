...
* [**Блок 2: Локальная работа с файлами**](#блок-2-локальная-работа-с-файлами)
  ...
  * [12. Файл gitignore (Файлы исключение которые не нужно добавлять в Git)](#12-файл-gitignore-файлы-исключение-которые-не-нужно-добавлять-в-git)
* [**Блок 3: Ветвление и совместная работа**](#блок-3-ветвление-и-совместная-работа)
  * [10. Ветки в Git](#10-ветки-в-git)
  ...
  * [11. Конфликты слияния веток в Git](#11-конфликты-слияния-веток-в-git)
  ...
  * [21. Работа в команде](#21-работа-в-команде)
...
* [**Блок 4: Отмена изменений и работа со stash**](#блок-4-отмена-изменений-и-работа-со-stash)
  * [16. Отмена несохранённых изменений](#16-отмена-несохранённых-изменений)
  * [17. Отмена сохранённых изменений](#17-отмена-сохранённых-изменений)
  ...
  * [18. Отмена слияния веток](#18-отмена-слияния-веток)
  * [19. Откладывание изменений](#19-откладывание-изменений)
  * [25. Храни временные изменения с заметкой](#25-храни-временные-изменения-с-заметкой)
  * [20. Перемещение изменений](#20-перемещение-изменений)
  * [22. История всех ваших шагов](#22-история-всех-ваших-шагов)
* [**Блок 5: Дополнительные и продвинутые инструменты**](#блок-5-дополнительные-и-продвинутые-инструменты)
  * [23. Повторное разрешение конфликтов](#23-повторное-разрешение-конфликтов)
  * [24. Автоматический поиск «битого» коммита](#24-автоматический-поиск-битого-коммита)
  * [26. Несколько рабочих копий одного репозитория](#26-несколько-рабочих-копий-одного-репозитория)
...
### 25. Храни временные изменения с заметкой
...
### 23. Повторное разрешение конфликтов
...
### 24. Автоматический поиск «битого» коммита
...
### 26. Несколько рабочих копий одного репозитория
