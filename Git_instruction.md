...
* [**Блок 5: Дополнительные и продвинутые инструменты**](#блок-5-дополнительные-и-продвинутые-инструменты)
  ...
  * [28. Несколько рабочих копий одного репозитория](#28-несколько-рабочих-копий-одного-репозитория)
...
```bash
git reflog             # Вернёт список всех HEAD-перемещений
git checkout HEAD@{3}  # Вернёт вас на три шага назад
```
