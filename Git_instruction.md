...
6. [Фиксация (сохранение) изменений](#6-фиксация-сохранение-изменений-в-файлах)
7. [Журнал изменений (Логирование)](#7-журнал-изменений)
8. [Переключение между версиями файла](#8-переключение-между-версиями-файла)
9. [Просмотр разницы между файлами](#9-просмотр-разницы-между-файлом-и-закоммиченным-файлом)
...
11. [Конфликты слияния](#11-конфликты-слияния-веток-в-git)
12. [Файл .gitignore](#12-файл-gitignore-файлы-исключение-которые-не-нужно-добавлять-в-git)
